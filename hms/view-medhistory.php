            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Usuarios | Historial médico</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Usuarios</span>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Usuarios<span class="text-bold">Historial
                                        médico</span></h5>
                                <?php
                               $vid=$_GET['viewid'];
...
while ($row=mysqli_fetch_array($ret)) { 
  ?>
                                    <tr>
                                        <td><?php echo $cnt;?></td>
                                        <td><?php  echo $row['Presión arterial'];?></td>
                                        <td><?php  echo $row['Peso'];?></td>
                                        <td><?php  echo $row['Glucemia'];?></td>
                                        <td><?php  echo $row['Temperatura'];?></td>
                                        <td><?php  echo $row['MedicalPres'];?></td>
                                        <td><?php  echo $row['Fecha de creación'];?></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;} ?>
                                </table>
