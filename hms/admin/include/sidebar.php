<div class="sidebar app-aside" id="sidebar">
    <div class="sidebar-container perfect-scrollbar">
        ...
        <nav>
            ...
            <!-- inicio: MENÚ PRINCIPAL DE NAVEGACIÓN -->
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="unread-queries.php">
                                <span class="title"> Consulta no leída </span>
                            </a>
                        </li>

                        <li>
                            <a href="read-query.php">
                                <span class="title"> Consulta de lectura </span>
                            </a>
                        </li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <div class="item-content">
                            ...
                            <div class="item-inner">
                                <span class="title"> Informes de pacientes </span><i class="icon-arrow"></i>
                            </div>
                        </div>
                    </a>
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="between-dates-reports.php">
                                <span class="title">Informes de fechas en b/n </span>
                            </a>
                        </li>
