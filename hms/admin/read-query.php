...
<head>
    <title>Administrador | Administrar consultas de lectura</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Administrar consultas de lectura</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                    <span>Consultas de lectura</span>
                                </li>
                            </ol>
                        </div>
                    </section>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Administrar <span class="text-bold">Consultas de
                                        lectura</span></h5>
