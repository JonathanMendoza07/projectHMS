...
check_login();
$did=intval($_GET['id']);// obtener identificación del médico
...
<head>
    <title>Administrador | Editar detalles del médico</title>
...
<body>
    <div id="app">
        ...
        <div class="app-content">
            ...
            <!-- inicio: CAMBIO DE MENÚ PARA DISPOSITIVOS MÓVILES -->
            <!-- y: BARRA DE NAVAJA SUPERIOR -->
...
?>
                                                ...
                                                <p><b>Fecha de registro de perfil:
