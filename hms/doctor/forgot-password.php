...
//Comprobando los detalles para restablecer la contraseña
    ...
    <div class="row">
        <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
            <div class="logo margin-top-30">
                <a href="../../index.html">
                    <h2> SGP | Recuperación de la contraseña del médico</h2>
                </a>
            </div>
            ...
            <div class="box-login">
                <form class="form-login" method="post">
                    <fieldset>
                        <legend>
                            Recuperación de la contraseña del médico
                        </legend>
                        <p>
                            Ingrese su número de contacto y correo electrónico para recuperar su contraseña.<br />
                        ...
                        <div class="form-group form-actions">
                            <span class="input-icon">
                                <input type="text" class="form-control" name="contactno"
                                    placeholder="Número de contacto registrado">
