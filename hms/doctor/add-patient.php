...
if($sql)
{
echo "<script>alert('Información del paciente agregada con éxito');</script>";
                                                ...
                                                <form role="form" name="" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="patcontact" class="form-control"
                                                            placeholder="Ingrese el número de contacto del paciente"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" id="patemail" name="patemail"
                                                            class="form-control"
                                                            placeholder="Ingrese la identificación del correo electrónico del paciente"
