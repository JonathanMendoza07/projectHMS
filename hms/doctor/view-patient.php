            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Administrar <span
                                        class="text-bold">Pacientes</span>
                                </h5>
                                <?php
                               $vid=$_GET['viewid'];
                               ...
                               ?>
                                <table border="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th scope>Correo electrónico del paciente</th>
  ...
  ?>
                                ...
                                <p align="center">
                                    <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal"
                                        data-target="#myModal">Agregar historial médico</button>
                                </p>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Agregar historial médico
                                                </h5>
                                                ...
                                                <table class="table table-bordered table-hover data-tables">
                                                    ...
                                                    <form method="post" name="submit">
                                                        ...
                                                        <tr>
                                                            <th>Presión arterial :</th>
                                                            <td>
                                                                <input name="bp" placeholder="Presión arterial"
                                                        ...
                                                        <tr>
                                                            <th>Glucemia :</th>
                                                            <td>
                                                                <input name="bs" placeholder="Glucemia"
                                                                    class="form-control wd-450" required="true">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <th>Temperatura corporal :</th>
                                                            <td>
                                                                <input name="temp" placeholder="Temperatura corporal"
                                                                    class="form-control wd-450" required="true">
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <th>Prescripción:</th>
                                                            <td>
                                                                <textarea name="pres" placeholder="Prescripción médica"
